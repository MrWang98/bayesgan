...
def ld_svhn(extended=False, test_only=False):
  ...
  local_urls = maybe_download(file_urls, data_dir)
...
def ld_cifar10(test_only=False):
  ...
  dataset = extract_cifar10(local_urls[0], data_dir)
...
def ld_mnist(test_only=False):
  ...
  '''file_urls1 = ['http://yann.lecun.com/exdb/mnist/train-images-idx3-ubyte.gz',
               'http://yann.lecun.com/exdb/mnist/train-labels-idx1-ubyte.gz',
               ]'''
